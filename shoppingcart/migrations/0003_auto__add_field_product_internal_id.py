...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.internal_id'
        db.add_column('products', 'internal_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.internal_id'
        db.delete_column('products', 'internal_id')
    ...
    models = {
        ...
        'shoppingcart.product': {
            ...
            'internal_id': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True', 'null': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
