...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.internal_id'
        db.alter_column('products', 'internal_id', self.gf('django.db.models.fields.CharField')(max_length=9, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Product.internal_id'
        db.alter_column('products', 'internal_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True))
    ...
    models = {
        ...
        'shoppingcart.product': {
            ...
            'internal_id': ('django.db.models.fields.CharField', [], {'max_length': '9', 'unique': 'True', 'null': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
